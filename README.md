...
## 👨‍💻 Kontributor
- Nama: Muhamad Lutfi
- Tools: TensorFlow, Keras, Python, OpenCV, Kaggle API

## 📌 Lisensi
Dataset ini merupakan milik [Kaggle Datasets - Animals10](https://www.kaggle.com/datasets/alessiocorrado99/animals10). Proyek ini untuk keperluan edukasi.
